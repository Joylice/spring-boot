 ...
 * removed unnecessary id from try block. Only decode packet is needed.
...
==================
  ...
  * Updated depedencies.
  * Bumped uglify
  * Tweaking id so it doesn't throw an exception when used inside a WebWorker in Firefox
